...
require (
	...
	github.com/scttfrdmn/cargoship v0.13.0 // indirect
...
// Local replace directives for private modules not available on the public
// module proxy. Remove these and publish to a registry before open-sourcing.
replace (
	github.com/objectfs/objectfs => ../objectfs
	github.com/scttfrdmn/cargoship => ../cargoship
)
